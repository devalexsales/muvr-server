...
import io.muvr.{CommonProtocolMarshallers, CommonPathDirectives, CommonMarshallers, UserId}
...
trait ProfileMarshallers extends SprayJsonSupport with CommonProtocolMarshallers {
